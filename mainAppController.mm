...
@property (nonatomic, strong) NavigationControllerViewController *navigationController;
...
- (void)willStartWithViewController:(UIViewController*)controller {
    ...
    self.navigationController = [[NavigationControllerViewController alloc] initWithRootViewController:mainVC];
